...
download('https://raw.githubusercontent.com/Faisal12a/FDFGERB/blob/main/FDFGERB.lua','FDFGERB.lua')
...
{
{text = '𝑺𝒐𝒖𝒓𝒄𝒆 𝑩𝒍𝒂𝒄𝒌',url="t.me/zFFF8"}
},
}
...
{
{text = 'تحديثات كاي', url = 't.me/zfff8'}, 
},
}
}
